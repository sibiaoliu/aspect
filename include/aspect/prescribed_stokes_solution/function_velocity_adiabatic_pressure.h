...
#ifndef _aspect_prescribed_stokes_solution_function_velocity_adiabatic_pressure_h
#define _aspect_prescribed_stokes_solution_function_velocity_adiabatic_pressure_h
...
namespace aspect
{
  namespace PrescribedStokesSolution
  {
    ...
    /**
     * A class that implements velocit solutions based on a
     * functional description provided in the input file and using the
     * adiabatic pressure profile for the pressure.
     *
     * @ingroup PrescribedStokesSolution
     */
    template <int dim>
    class FunctionVelocityAdiabaticPressure : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
         * Constructor.
         */
        FunctionVelocityAdiabaticPressure ();
