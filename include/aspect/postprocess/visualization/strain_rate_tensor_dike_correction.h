...
#ifndef _aspect_postprocess_visualization_strain_rate_tensor_dike_correction_h
#define _aspect_postprocess_visualization_strain_rate_tensor_dike_correction_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * components (in 2d and 3d, respectively) of the strain rate tensor every
