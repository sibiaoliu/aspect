                ...
                if (healing_mechanism == fracture_healing && plastic_yielding == true)
                  {
                    ...
                    delta_e_ii_plastic = composition_evaluators[strain_index]->get_value(0) / (1+fracture_healing_part)
                                         - composition_evaluators[strain_index]->get_value(0);
                    out.reaction_terms[i][strain_index] = std::max(delta_e_ii_plastic, -in.composition[i][strain_index]);
                  }
                else  
