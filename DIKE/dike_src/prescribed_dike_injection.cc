  ...
  namespace MaterialModel
  {
                                      ...
                                      typename Interface<dim>::MaterialModelOutputs &out) const
    {
      ...
      *prescribed_dilation = (this->get_parameters().enable_prescribed_dilation)
      ...
      //TODO: Should we set the injection value for the entire element, instead of
              ...
              for (unsigned int c=0; c<this->n_compositional_fields(); ++c)
                {
                  if (c == injection_phase_index)
                    ...
                    {
                      // TODO: how to define the chemical compositional fields, instead of elasticity?
                      // Calculating reaction terms for other chemical compositional fields
                      if (composition[c] < 0.0)
                        out.reaction_terms[i][c] = -composition[c];
                  ...
                  // Remove the effect of dike injection on non-chemical compositions, such as plastic_strain, elastic stresses
                      ...
                      if (dim == 2)
                        {
                          ...
                          if (c == index_ve_stress_xx || c == index_ve_stress_yy || c == index_ve_stress_xy)
                            out.reaction_terms[i][c] = 0.0;
                        }
                      else //if (dim == 3)
                        {
                          ...
                          if (c == index_ve_stress_xx || c == index_ve_stress_yy || c == index_ve_stress_zz
                              || c == index_ve_stress_xy || c == index_ve_stress_xz || c == index_ve_stress_yz)
                            out.reaction_terms[i][c] = 0.0;
                        } 
                    }      
                }
